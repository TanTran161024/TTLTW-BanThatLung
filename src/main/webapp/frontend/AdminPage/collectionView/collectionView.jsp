                    ...
                    <div class="col-11 bg-light">
                        <div class="d-flex flex-column">
                            <div class="ms-5 mt-5 ml-5">
                                <h1 class="fw-bold">Bộ sưu tập ${param.id}</h1>
                                ...
                                <div class="d-flex justify-content-center mt-5 w-100">
                                    <table class="table text-center">
                                        ...
                                        <c:forEach var="b" items="${beltsList}">
                                            <tr>
                                                <th class="p-4 fs-5 orderItemId" scope="row">${b.id}</th>
                                                <td class="p-4 fs-5">${b.name}</td>
                                                <td class="p-4 fs-5">${b.releaseDate}</td>
                                                <td class="p-4 fs-5">${b.price}</td>
                                                <td class="p-4 fs-5">
...
<div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Xóa mục sưu tập này</h5>
            ...
            <div class="modal-footer">
                ...
                <form class="deleteBtn" action="${pageContext.request.contextPath}/admin/table/collections/details"
                      method="post">
                    <input type="hidden" name="orderId" value="${param.id}">
                    <input type="hidden" name="message" value="delete">
                    <c:if test="${beltsList.size()==1}"><input type="hidden" name="oneItem"
                                                               value="1"></c:if>
...
<script src="${pageContext.request.contextPath}/js/collectionView.js"></script>
</body>
</html>
